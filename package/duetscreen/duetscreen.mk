...
DUETSCREEN_SITE = /home/christian/Duet3D/DuetScreen
...
define DUETSCREEN_BUILD_CMDS
	cd $(@D); \
	$(TARGET_MAKE_ENV) $(DUETSCREEN_BUILD_ENV) $(BR2_CMAKE) --build $(DUETSCREEN_BUILDDIR) --preset $(DUETSCREEN_PRESET) -j$(PARALLEL_JOBS) $(DUETSCREEN_BUILD_OPTS)
endef
